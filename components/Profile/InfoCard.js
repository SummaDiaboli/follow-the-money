...
const InfoCard = ({ likes, followers, friends, posts }) => {
    return (
        <div className="card py-3 px-0">
            <div className="row m-0 profile-details w-100">
                <div className="col-3 text-center">
                    <h6 className="color-red">{likes} <span className="small">likes</span></h6>
                </div>
                <div className="col-3 text-center">
                    <h6 className="color-red">{followers} <span className="small">followers</span></h6>
                </div>
                <div className="col-3 text-center">
